...
java -jar ../kover/kover-cli-0.8.0.jar report ../output/tmp/kover-report.ic --classfiles "$COMPILER_DIR/kotlinc/lib/kotlin-compiler.jar" --src ../output/tmp --html "$HTML_OUTPUT_DIR"
